...
$( document ).on( "pagecreate", ".jqm-syt", function( event ) {
	var search,
		page = $( this ),
		that = this,
	...
	if ( $( event.target ).hasClass( "jqm-syt-search-results") ) {
...
$( document ).one( "pagecreate", ".jqm-syt", function( event ) {
